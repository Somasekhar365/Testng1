...
public class Test001 extends Baseclass {
	...
	private void bookAHotel() {
		driver.findElement(By.id("first_name")).sendKeys("sekhar");
		driver.findElement(By.name("last_name")).sendKeys("nadipalli");
		driver.findElement(By.xpath(".//textarea[@rows='4']")).sendKeys("mlkh");
		driver.findElement(By.xpath(".//input[@id='cc_num']")).sendKeys("76534653446");
